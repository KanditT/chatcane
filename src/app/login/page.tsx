...
const Login = () => {
  ...
  return (
      <div className="flex min-h-screen">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 lg:px-24  text-foreground dark:text-foreground">
          <div>
            ...
            <button
                className="w-full py-2 mb-4 bg-white dark:bg-asideBG text-gray-800 dark:text-foreground font-semibold rounded-lg flex items-center justify-center shadow-md hover:bg-aBGHover hover:text-aHoverTextColor"
            ...
            <div className="flex items-center mb-4">
              ...
              <span className="mx-2 text-aTextColor text-sm">
            ...
            <div className="mb-4">
              <label
                  htmlFor="email"
                  className="block text-sm font-semibold mb-1 text-h2Color"
              >
                Email
              </label>
              <input
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center">
                ...
                <label htmlFor="remember" className="text-aTextColor text-sm">
                  Remember me
                </label>
              </div>
              <a
                  href="#"
                  className="text-sm text-aHoverTextColor hover:underline"
              >
                Forgot password?
              </a>
            </div>
            ...
            <button
                className="w-full py-3 bg-green-600 hover:bg-green-800 text-white font-semibold rounded-lg transition duration-300"
