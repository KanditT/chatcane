...
import { FaHome, FaUser, FaTable, FaBell, FaSignInAlt, FaUserPlus, FaCog, FaInfoCircle, FaQuestionCircle, FaMoon } from 'react-icons/fa';
...
const Sidebar: React.FC = () => {
    ...
    return (
        <aside className="absolute top-3 left-3 h-[calc(100vh-1.5rem)] w-64  flex flex-col border border-gray-700 rounded-lg p-4">
            {/* Sidebar Header */}
            <span className="aside flex items-end justify-center h-12 mb-4">
                <h1
                ...
                <div ref={settingsRef} className="fixed bottom-16 left-16  p-4 rounded-lg shadow-lg w-64 border-2 border-blue-500">
                    <div className="flex items-center justify-between">
                        <span className="flex items-center">
                            ...
                            {theme === 'dark' ? 'Light Mode' : 'Dark Mode'}  {/* Dynamic text based on theme */}
                        </span>
